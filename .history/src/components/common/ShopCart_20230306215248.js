							...
							<div className="right-inner">
								<div className="delivery">
									<div className="delivery-container">
                                        ...
                                        <div className="address note-cart" >
											<textarea className=''  onChange={handleChangeNote} placeholder='ghi chú ...'></textarea>
										</div>
                                        <div className="address note-cart">
                                            <select className='form-control' onChange={handleChangeNote} name='type'>
